...
/**
 * Main Activity having the Side Drawer and Action Bar
 * @author amansharma
 *
 */
public class HomeActivity extends ActionBarActivity {
	...
	private void setUpDrawer() {
		mActionBarDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout, R.drawable.apptheme_ic_navigation_drawer, 0, 0);
